...
"}")
        ...
        self.gridLayout_3.addWidget(self.input_01, 1, 2, 1, 1)
        ...
        self.input_00 = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(16)
        self.input_00.setFont(font)
        self.input_00.setText("")
        self.input_00.setObjectName("input_00")
        self.gridLayout_3.addWidget(self.input_00, 1, 1, 1, 1)
        ...
        self.btn_creat = QtWidgets.QPushButton(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(16)
        self.btn_creat.setFont(font)
        self.btn_creat.setObjectName("btn_creat")
        self.gridLayout_3.addWidget(self.btn_creat, 13, 0, 1, 5)
        ...
        MainWindow.setTabOrder(self.input_00, self.input_01)
        MainWindow.setTabOrder(self.input_01, self.btn_reg)
        ...
        MainWindow.setTabOrder(self.input_71, self.lineEdit_28)
        MainWindow.setTabOrder(self.lineEdit_28, self.input_73)
        ...
        MainWindow.setTabOrder(self.input_83, self.btn_creat)
        MainWindow.setTabOrder(self.btn_creat, self.input_14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_01.setPlaceholderText(_translate("MainWindow", "证书编号"))
        self.label_5.setText(_translate("MainWindow", "1"))
        self.label_2.setText(_translate("MainWindow", "风表示值Vz（格） "))
        self.input_00.setPlaceholderText(_translate("MainWindow", "0.00"))
        ...
        self.btn_creat.setText(_translate("MainWindow", "生成报告"))
